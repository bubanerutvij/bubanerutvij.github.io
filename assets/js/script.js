...
!(function (e) {
            ...
            return (
                ...
                (i.hasClass("has-children")
                    ? i.hasClass("nav-opened")
                        ? (i.removeClass("nav-opened"), "#" !== l || (t(i.children("ul"), "close"), !1))
    ...
    C.length > 0 &&
        C.each(function () {
            ...
            a.owlCarousel({
                ...
                autoplayTimeout: l,
                autoplaySpeed: 300,
                responsive: { 0: { items: 1 }, 480: { items: i }, 768: { items: s }, 1170: { items: t } },
            });
        });
    var y = e(".btc-ticker");
    y.length > 0 && y.owlCarousel({ items: 7, loop: !0, margin: 0, center: !0, stagePadding: 0, responsive: { 0: { items: 1 }, 400: { items: 2, center: !1 }, 599: { items: 3 }, 1024: { items: 5 }, 1170: { items: 7 } } });
    var b = e(".header-slider");
    b.length > 0 &&
        b.owlCarousel({ items: 1, margin: 0, dots: !1, loop: !0, nav: !0, autoplay: !1, animateIn: "fadeIn", animateOut: "fadeOut", navText: ["<span class='pe pe-7s-angle-left'></span>", "<span class='pe pe-7s-angle-right'></span>"] });
    var w = e(".imagebg");
    w.length > 0 &&
        w.each(function () {
            var a = e(this),
            ...
            void 0 !== i &&
                "" !== i &&
                (t.hasClass("has-bg-image") || t.addClass("has-bg-image"), "" !== l && "dark" === l[0] && (t.hasClass("light") || t.addClass("light")), a.css("background-image", 'url("' + i + '")').addClass("bg-image-loaded"));
        });
    ...
    j.length > 0 &&
        i.on("load", function () {
            j.children().fadeOut(300), j.delay(150).fadeOut(500), e("body").delay(100).css({ overflow: "visible" });
        }),
        l.append(
